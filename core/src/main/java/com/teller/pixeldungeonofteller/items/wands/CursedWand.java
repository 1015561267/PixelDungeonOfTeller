...
import com.teller.pixeldungeonofteller.actors.blobs.Regrowth;
                        ...
                        public void call() {
                            ...
                            switch (Random.Int(2)) {
                                case 0:
                                    ...
                                    target.damage(new AbsoluteDamage(damage, this, target), wand);
                                    target.sprite.emitter().start(ShadowParticle.UP, 0.05f, 10);
                                    break;
                                case 1:
                                    user.damage(new AbsoluteDamage(damage, this, user), this);
