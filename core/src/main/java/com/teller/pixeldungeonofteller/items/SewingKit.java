...
public class SewingKit extends Item {
    ...
    //private static final String TXT_UPGRADED		= "you patched your %s";
    ...
    private final WndBag.Listener itemSelector = new WndBag.Listener() {
        ...
        public void onSelect(Item item) {
            if (item != null) {
                SewingKit.this.patch((Armor) item);
            }
        }
    };
    ...
    {
        stackable = true;
        image = ItemSpriteSheet.SEWING_KIT;
