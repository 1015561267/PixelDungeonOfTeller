...
import com.teller.pixeldungeonofteller.scenes.ChangesScene;
...
public class v0_2_X_Changes {
	...
	public static void add_v0_2_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.DART, null), "Pixel Dungeon v1.7.2",
