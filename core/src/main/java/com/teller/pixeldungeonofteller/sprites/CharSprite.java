...
import com.teller.pixeldungeonofteller.effects.DarkBlock;
import com.teller.pixeldungeonofteller.effects.EmoIcon;
import com.teller.pixeldungeonofteller.effects.FloatingText;
import com.teller.pixeldungeonofteller.effects.IceBlock;
import com.teller.pixeldungeonofteller.effects.Speck;
import com.teller.pixeldungeonofteller.effects.Splash;
import com.teller.pixeldungeonofteller.effects.TorchHalo;
import com.teller.pixeldungeonofteller.effects.particles.CursedFlameParticle;
...
public class CharSprite extends MovieClip implements Tweener.Listener, MovieClip.Listener {
    ...
    public static final int HPDMG = 0xFF0000;
    public static final int SHLDDMG = 0x87CEFF;
    public static final int ARMORDMG = 0xB8860B;
    ...
    public enum State {
        BURNING, CURSEDFLAME, LEVITATING, INVISIBLE, PARALYSED, FROZEN, ILLUMINATED, CHILLED, DARKENED, MARKED
    }
    ...
    public void add(State state) {
        switch (state) {
            ...
            case CURSEDFLAME:
                burning = emitter();
                burning.pour(CursedFlameParticle.FACTORY, 0.06f);
                if (visible) {
                    Sample.INSTANCE.play(Assets.SND_BURNING);
                }
                break;
