...
import com.teller.pixeldungeonofteller.ui.WndKeyBindings;
...
import static com.teller.pixeldungeonofteller.windows.WndTitledMessage.WIDTH_L;
import static com.teller.pixeldungeonofteller.windows.WndTitledMessage.WIDTH_P;

import static com.teller.pixeldungeonofteller.levels.traps.Trap.WHITE;
...
public class WndSettings extends WndTabbed {
    ...
    public WndSettings() {
        ...
        IconTab langsTab = new IconTab(Icons.get(Icons.PREFS)){
            @Override
            protected void select(boolean value) {
                super.select(value);
    ...
    public void hide() {
        ...
        PixelDungeonOfTeller.seamlessResetScene(new Game.SceneChangeCallback() {
            @Override
            ...
            if (!DeviceCompat.isDesktop() && PixelScene.maxScreenZoom >= 2) {
                chkSaver = new CheckBox(Messages.get(this, "saver")) {
                    ...
                    protected void onClick() {
                        ...
                        if (checked()) {
                            checked(!checked());
                            PixelDungeonOfTeller.scene().add(new WndOptions(Icons.get(Icons.PREFS),
        ...
        protected void createChildren() {
            ...
            if (DeviceCompat.hasHardKeyboard()){
                ...
                btnKeyBindings = new RedButton(Messages.get(this, "key_bindings")){
                    ...
                    protected void onClick() {
                        super.onClick();
                        PixelDungeonOfTeller.scene().addToFront(new WndKeyBindings());
                    }
                };
            ...
            if (currLang != Languages.ENGLISH) {
                ...
                btnCredits = new RedButton(credText, credText.length() > 9 ? 6 : 9) {
                    ...
                    protected void onClick() {
                        ...
                        PixelDungeonOfTeller.scene().addToFront(credits);
                    }
                };
                add(btnCredits);
            }
