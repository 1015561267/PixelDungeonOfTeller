...
public class GamesInProgress {
    ...
    public static String gameFile( int slot ){ return gameFolder(slot) + "/" + GAME_FILE; }
    public static String depthFile( int slot, int depth )  { return gameFolder(slot) + "/" + Messages.format(DEPTH_FILE, depth); }
    ...
    public static Info check( int slot ) {
        ...
        if (slotStates.containsKey( slot )) {
            ...
            try {
                ...
                if (info.version < PixelDungeonOfTeller.v0_0_1a) {
                    info = null;
                }
