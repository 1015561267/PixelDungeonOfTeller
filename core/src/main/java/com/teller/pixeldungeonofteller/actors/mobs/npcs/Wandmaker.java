...
import com.teller.pixeldungeonofteller.levels.rooms.special.RotGardenRoom;
import com.teller.pixeldungeonofteller.levels.rooms.standard.RitualSiteRoom;
import com.teller.pixeldungeonofteller.messages.Messages;
import com.teller.pixeldungeonofteller.plants.Rotberry;
import com.teller.pixeldungeonofteller.scenes.GameScene;
import com.teller.pixeldungeonofteller.sprites.WandmakerSprite;
import com.teller.pixeldungeonofteller.windows.WndQuest;
import com.teller.pixeldungeonofteller.windows.WndWandmaker;
        ...
        if (Quest.given) {
            ...
            if (item != null) {
                ...
                Game.runOnRenderThread(new Callback() {
                    @Override
                    public void call() {
                        GameScene.show(new WndQuest(Wandmaker.this, finalMsg));
                    }
                });
            }
        } else {
