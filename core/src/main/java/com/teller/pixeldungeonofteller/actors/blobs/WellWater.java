...
public abstract class WellWater extends Blob {
    ...
    public static void affectCell(int cell) {
        ...
        for (Class<?> waterClass : waters) {
            ...
            //if(water==null)
            //{
            //    GLog.i("waternull"+Random.Int(100));
           // }
            //else if(!water.affect(cell))
            //{
            //    GLog.i("noeffect"+Random.Int(100));
            //}
            //else if(water.pos!=cell)
            //{
            //    GLog.i("posdismatch"+Random.Int(100));
            //}
            if (water != null &&
                    water.volume > 0 &&
                    water.cur[cell] > 0 &&
                    water.affect(cell)) {
               // GLog.i("wateraffect"+Random.Int(100));
                Level.set(cell, Terrain.EMPTY_WELL);
                GameScene.updateMap(cell);
                return;
            }
            //else
             //   GLog.i("noaffect"+Random.Int(100));
        }
    }
}
