...
import com.teller.pixeldungeonofteller.sprites.KingSprite;
import com.teller.pixeldungeonofteller.sprites.UndeadSprite;
...
public class King extends Mob {
    ...
    public PhysicalDamage damageRoll() {
        ...
        dmg.AddSlash(Random.NormalIntRange(8, 30));
        dmg.AddPuncture(Random.NormalIntRange(6, 12));
    ...
    public void damage(Damage dmg, Object src) {
        ...
        if (lock != null) lock.addTime((dmg.effictivehpdamage + dmg.effictiveslddamage));
    }
    ...
    public void die(Object cause) {
        ...
        Dungeon.level.drop(new SewingKit(), pos).sprite.drop();
    ...
    public static class Undead extends Mob {
        ...
        public PhysicalDamage damageRoll() {
            ...
            dmg.AddPuncture(Random.NormalIntRange(2, 4));
            dmg.AddImpact(Random.NormalIntRange(6, 16));
            return dmg;
        }
